...
@app.get("/api/atari/session/<session_id>/mix.wav")
...
@app.get("/api/atari/session/<session_id>/stem/<stem_name>.wav")
...
@app.post("/api/atari/session/<session_id>/export")
